...
LoaderMetadata.prototype = {
    ...
    addBundle: function(asyncPathInfo, bundle) {
        var pathInfo = raptorModulesUtil.getPathInfo(asyncPathInfo.path, {removeExt: false});
        ...
        if (asyncPathInfo.alias) {
            var aliasFromPathInfo = raptorModulesUtil.getPathInfo(asyncPathInfo.aliasFrom);
