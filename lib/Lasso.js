...
Lasso.prototype = {
    ...
    buildLassoCacheKey: function(lassoContext) {
        ...
        cacheKey_add('config:' + (lassoContext.config.cacheKey || lassoContext.config.getConfigFingerprint()));
    ...
    createLassoContext: function(options) {
        ...
        lassoContext.cache = options.cache !== false ? this.getLassoCache(lassoContext) : undefined;
