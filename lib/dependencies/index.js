...
function registerType(type, mixins) {
    var isManifestDependency = mixins._manifestDependency = mixins.manifestDependency === true;
    delete mixins.manifestDependency;
