...
function registerType(type, mixins) {
    ...
    if (!isManifestDependency && (!mixins.getCode || typeof mixins.getCode !== 'function')) {
        throw new Error('Unable to register dependency type of "' + type + '". getCode() is a required function.');
    }
