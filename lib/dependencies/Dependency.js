...
function Dependency(dependencyConfig, dirname, filename) {
    ...
    if (dependencyConfig['if']) {
        this._condition = condition.ifCondition(dependencyConfig['if']);
    } else if (dependencyConfig['if-extension']) {
        this._condition = condition.ifExtension(dependencyConfig['if-extension']);
    } else if (dependencyConfig['if-not-extension']) {
        this._condition = condition.ifNotExtension(dependencyConfig['if-not-extension']);
    }
