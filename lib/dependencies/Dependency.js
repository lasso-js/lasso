...
function Dependency(dependencyConfig, dirname, filename, asyncPackageName) {
...
Dependency.prototype = {
            ...
            this.loadPackageManifest(optimizerContext, function(err, result) {
                ...
                if (typeof result === 'string') {
                    ...
                    manifest = new OptimizerManifest({
                        ...
                        asyncPackageName: _this.getAsyncPackageName()
                    });
                } else {
                    manifest = result;
                }
    ...
    createPackageManifest: function(manifest, dirname, filename) {
        ...
        return new OptimizerManifest({
            ...
            asyncPackageName: this.getAsyncPackageName()
        });
    },
    ...
    getAsyncPackageName: function() {
        return this._asyncPackageName;
    },
