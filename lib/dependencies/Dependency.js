...
Dependency.prototype = {
    ...
    getPackageManifest: function(context) {
        ...
        if (!this.loadPackageManifest || typeof this.loadPackageManifest !== 'function') {
            throw new Error('getPackageManifest() failed. loadPackageManifest is a required function: ' + this.toString());   
        }
