...
DependencyRegistry.prototype = {
    ...
    _normalizeDependency: function(dependency, callback) {
        ...
        function applyNextNormalizer() {
            ...
            if (normalizeFunc.length === 1) {
                ...
                normalizeFunc(dependency, function (err, d) {
                    if (err) {
                        return callback(err);
                    }
    ...
    normalizeDependencies: function(dependencies, dirname, filename, callback) {
        ...
        function normalizeNext() {
            ...
            _this._normalizeDependency(dependency, function(err, dependency) {
                if (err) {
                    return callback(err);
                }
