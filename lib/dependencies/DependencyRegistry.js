...
DependencyRegistry.prototype = {
    ...
    registerRequireExtension: function(ext, options) {
        if (typeof options === 'function') {
            ...
            if (!options.lastModified) {
                options.lastModified = defaultLastModified;
            }
     ...
     * https://github.com/raptorjs3/raptor-optimizer-rhtml/blob/master/lib/raptor-optimizer-rhtml-plugin.js
     *
     *
     *
    ...
    registerRequireType: function(type, mixins) {
        ...
        var requireLastModified = mixins.lastModified;
            ...
            callback(null, [
                {
                    ...
                    _requireLastModified: function(callback) {
                        if (requireLastModified) {
                            callback(null, -1);
                        } else {
                            requireLastModified.call(_this, optimizerContext, callback);
                        }
                    }
                }
            ]);
        ...
        this.registerRequireExtension(type, {
            ...
            lastModified: function(path, optimizerContext, callback) {
                ...
                return requireLastModified.call(_this, optimizerContext, callback);
            }
        });
    },
    ...
    getRequireHandler: function(path, optimizerContext) {
        ...
        var lastModified = requireExt.lastModified;
        ...
        return {
            ...
            lastModified: function(callback) {
                ...
                lastModified(path, optimizerContext, function(err, lastModified) {
                    if (err) {
