...
var typePathRegExp = /^(\w{2,})\s*:\s*(.+)$/; // Hack: {2,} is used because Windows file system paths start with "c:\"
...
DependencyRegistry.prototype = {
     ...
     * https://github.com/raptorjs/optimizer-marko/blob/master/lib/optimizer-marko-plugin.js
     *
     *
     *
