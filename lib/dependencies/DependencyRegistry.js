...
DependencyRegistry.prototype = {
    ...
    registerRequireType: function(type, mixins) {
        ...
        var userGetDependencies = mixins.getDependencies;
        ...
        this.registerRequireExtension(type, {
            ...
            getDependencies: userGetDependencies,
    ...
    getRequireHandler: function(path, lassoContext) {
        ...
        var getDependencies = requireExt.getDependencies;
        ...
        return {
            ...
            getDependencies: function() {
                ...
                return new Promise((resolve, reject) => {
                    var result = getDependencies(lassoContext, (err, dependencies) => {
                        if (err) {
                            reject(err);
                        } else {
