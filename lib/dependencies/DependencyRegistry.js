...
DependencyRegistry.prototype = {
    ...
    registerType: function(type, mixins) {
        ...
        function Ctor(dependencyConfig, dirname, filename, asyncPackageName) {
            this.__dependencyRegistry = _this;
            Dependency.call(this, dependencyConfig, dirname, filename, asyncPackageName);
        }
    ...
    createDependency: function(config, dirname, filename, asyncPackageName) {
        if (!config) {
        ...
        return new Ctor(config, dirname, filename, asyncPackageName);
    },
