...
function doOptimizePage(theLasso, options, lassoContext, callback) {
    ...
    getOptimizerManifestFromOptions(options, theLasso.dependencies, function(err, lassoManifest) {
        if (!lassoManifest) {
...
function doOptimizeResource(theLasso, path, options, lassoContext, callback) {
...
Lasso.prototype = {
    ...
    /**
     * A OptimizerContext is created for each call to Lasso::optimizePage
