/**
 * The lasso module is used to generated optimized
 ...
 * Simple usage:
 * <js>
 * var lasso = require('raptor/lasso');
 * lasso.configure('path/to/lasso-config.xml', params);
 * var optimizedPage = lasso.optimizePage({
 *         name: "test-page",
 ...
 * </js>
 *
 * For more information, please see the <a href="http://raptorjs.org/lasso/">Optimizer Documentation</a>.
 */
