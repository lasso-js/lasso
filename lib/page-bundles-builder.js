...
function build(options, config, bundleMappings, optimizerContext) {
    ...
    function buildPageBundles() {
        ...
        function assignDependenciesToBundles() {
            ...
            var debugTree =  infoEnabled ? new DependencyTree() : null;
                    ...
                    on: {
                        ...
                        dependency: function(dependency, context) {
                            if (dependency.isPackageDependency()) {
                                if (debugTree) {
                                    debugTree.add(dependency, context.parentDependency);
                                }
                            ...
                            var bundle = bundlingStrategy.getBundleForSyncDependency(dependency, context, debugTree);
                            if (bundle) {
        ...
        function assignAsyncDependenciesToBundles() {
            ...
            var debugTree = logger.isInfoEnabled() ? new DependencyTree() : null;
                    ...
                    on: {
                        dependency: function(d, context) {
                            ...
                            if (d.isPackageDependency()) {
                                if (debugTree) {
                                    debugTree.add(d, context.parentDependency);
                                }
                                return;
                            }
