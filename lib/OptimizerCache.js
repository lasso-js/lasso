...
var DEFAULT_BASE_CACHE_DIR = nodePath.join(require('app-root-dir').get(), '.cache/raptor-optimizer');
...
function OptimizerCache(key, options) {
    ...
    this.baseCacheName = safeFilename(cacheProfileName) + (key ? '/' + safeFilename(key) : '');
