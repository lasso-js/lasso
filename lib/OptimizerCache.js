...
function OptimizerCache(key) {
    ...
    this.dependencyFingerprintsCache = cacheManager.getCacheByName(
        nodePath.join('raptor-optimizer', key, 'dependencyFingerprints'), DEPENDENCY_CHECKSUM_CACHE_CONFIG);
}
