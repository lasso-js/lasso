...
PageOptimizer.prototype = {
    ...
    resolveEnabledExtensions: function(optimizerRenderContext, options) {
        ...
        if (options) {
            ...
            if (enabledExtensions) {
                if (!extensions.isExtensionSet(enabledExtensions)) {
                    if (typeof enabledExtensions === 'string') {
                        enabledExtensions = enabledExtensions.split(/\s*,\s*/);
                    }
                    enabledExtensions = extensions.createExtensionSet(enabledExtensions);
                }
    ...
    optimizePage: function(options) {
        ...
        if (context) {
            if (!(context instanceof OptimizerContext)) {
                require('raptor-util').extend(new OptimizerContext(), context);
            }
        }
        else {
        ...
        optimizedPage.context = optimizedPage;
