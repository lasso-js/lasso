...
PageOptimizer.prototype = {
    ...
    _resolveEnabledExtensions: function(options) {
    ...
    createOptimizerContext: function(options) {
        ...
        optimizerContext.enabledExtensions = this._resolveEnabledExtensions(options);
    ...
    optimizeResourceCached: function(path, optimizerContext, callback) {
        ...
        if (!optimizerContext) {
            optimizerContext = this.createOptimizerContext();
        }
