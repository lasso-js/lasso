...
PageOptimizer.prototype = {
        ...
        function buildBundleMappings() {
            ...
            function getParentBundleMappings() {
                if (config.isBundlingEnabled()) {
                    ...
                    return _this.getBundleMappingsCached(bundleSetConfig, optimizerContext);
                }
            }
    ...
    getBundleMappingsCached: function(bundleSetConfig, optimizerContext) {
        var optimizerCache = this.getOptimizerCache(optimizerContext);
        var cacheKey = bundleSetConfig._id;
        var _this = this;

        return optimizerCache.getBundleMappings(cacheKey, function() {
            return _this.createBundleMappings(bundleSetConfig, optimizerContext);
        });
    },
    ...
    createOptimizerContext: function(options) {
        ...
        if (options) {
            ...
            if (options.optimizerContext) {
                raptorUtil.extend(optimizerContext, options.optimizerContext);
