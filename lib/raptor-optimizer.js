...
function configure(config, baseDir, filename) {
    return raptorPromises.resolved(createPageOptimizer(config, baseDir, filename));
}

function configureDefault(config, baseDir, filename) {
    defaultPageOptimizer = configure(config, baseDir, filename);
    return defaultPageOptimizer;
}
...
exports.configureDefault = configureDefault;
...
require('raptor-modules/optimizer').registerDependencyTypes(exports);
