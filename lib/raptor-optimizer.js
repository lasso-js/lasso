...
function optimizePage(pageConfig, callback) {
    ...
    return getDefaultPageOptimizer().then(function(pageOptimizer) {
        return pageOptimizer.optimizePage(pageConfig, callback);
    });
}

function resolveResourceUrl(path, context, callback) {
    return getDefaultPageOptimizer().then(function(pageOptimizer) {
        return pageOptimizer.resolveResourceUrl(path, context, callback);
    });
}
