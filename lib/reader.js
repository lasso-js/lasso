...
function createReadDependencyStream(dependency, lassoContext, transformerDataHolder) {
...
function createReadBundleStream(bundle, lassoContext, transformerDataHolder) {
...
function createBundleReader(bundle, lassoContext) {
    ...
    return {
        readBundle: function() {
            return createReadBundleStream(bundle, lassoContext, transformerDataHolder);
        },
        ...
        readDependency: function(dependency) {
            ...
            return createReadDependencyStream(dependency, lassoContext, transformerDataHolder);
        },
