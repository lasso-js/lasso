...
var minifyJSPlugin = require('raptor-optimizer-minify-js');
var minifyCSSPlugin = require('raptor-optimizer-minify-css');
var resolveCssUrlsPlugin = require('raptor-optimizer-resolve-css-urls');
...
function load(options, baseDir, filename) {
    ...
    if (options.resolveCssUrls == null) {
        options.resolveCssUrls = true;
    }
            ...
            if (value != null) {
                ...
                if (Array.isArray(value)) {
                    for (var i=0; i<value.length; i++) {
                        ...
                        if (pluginInfo.enabled === false || pluginConfig.enabled === false) {
                            continue;
                        }
                        ...
                        config.addPlugin(pluginFunc, pluginInfo.config || {});
                    }
                }
            }
        },
