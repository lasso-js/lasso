...
describe('lasso-require' , function() {
    ...
    it('should allow for custom require extensions', function(done) {
        ...
        myLasso.lassoPage({
                ...
                var actual = writerTracker.getCodeForFilename('hello.foo.js');
                expect(actual).to.contain('HELLO WORLD');
                expect(actual).to.contain('"/hello.foo"');
                ...
                // var actual = writerTracker.getCodeForFilename('test.marko.js');
                // console.log(actual);
    ...
    it('should allow for require.resolve', function(done) {
        ...
        myLasso.lassoPage({
                ...
                var helloFooSrc = writerTracker.getCodeForFilename('hello.foo.js');
                var resolveMainSrc = writerTracker.getCodeForFilename('resolve-main.js');
                expect(helloFooSrc).to.contain('HELLO WORLD');
                expect(helloFooSrc).to.contain('"/hello.foo"');
                expect(resolveMainSrc).to.contain('"/resolve-main"');
                expect(resolveMainSrc).to.contain('./hello.foo');
