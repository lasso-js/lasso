    ...
    it('should allow for output transforms', function(done) {
        ...
        pageOptimizer.optimizePage({
            ...
            .then(function(optimizedPage) {
                ...
                expect(writer.getCodeForFilename('testPage.js')).to.equal('transformsA_js-JavaScriptTransform1Async-JavaScriptTransform2Async');
                expect(writer.getCodeForFilename('testPage.css')).to.equal('TRANSFORMSA_CSS-CSSTRANSFORM1-CSSTransform2');
            })
            .then(done)
            .fail(done);
    });
    ...
    it('should allow for image URLs in CSS files to be resolved when bundling is disabled', function(done) {
        ...
        pageOptimizer.optimizePage({
            ...
            .then(function(optimizedPage) {
                ...
                var actual = writer.getCodeForFilename('css-url-transform.css');
                // console.log(actual);
                expect(actual).to.equal(expected);
    ...
    it('should allow for custom require extensions', function(done) {
        ...
        pageOptimizer.optimizePage({
            ...
            .then(function(optimizedPage) {
                ...
                // var expected = '.test-1 {background-image: url(ebay-logo.png);}\n.test-2 {background-image: url(ebay-logo.png);}\n.test-3 {background-image: url(ebay-logo.png);}\n.test-4 {background-image: url(data:image/png;base64,);}';
                // var actual = writer.getCodeForFilename('test.rhtml.js');
                // console.log(actual);
                // expect(actual).to.equal(expected);
