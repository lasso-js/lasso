...
exports.checkError = function(e) {
    ...
    expect(errorString).to.contain('Error: Module not found: ./c (from "test/modules-autotest/missing-module" and referenced in "test/modules-autotest/missing-module/b.js")');
};